...
export function InputNumber({
  ...
  return (
    <div className={`relative ${containerStyle}`}>
      ...
      <TbMobiledata className="pointer-events-none absolute left-4 top-1/2 z-10 -translate-y-1/2 text-[20px] text-gray-400 transition-colors duration-300 peer-focus:text-[#7CCA9E]" />
